...
I'm a graduate research assistant under the mentorship of [Professor Liping Wang](https://scholar.google.com/citations?hl=en&user=vf17MokAAAAJ). And I'm also a 2022 [OMSCS](https://omscs.gatech.edu/) alum, and my favoriate courses are [GIOS](https://omscs.gatech.edu/cs-6200-introduction-operating-systems) and [Network Security](https://omscs.gatech.edu/cs-6262-network-security).
With my background in *Computer Science*, I have worked on several *interesting* building simulations:
